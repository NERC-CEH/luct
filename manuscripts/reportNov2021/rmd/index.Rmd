...
<!--- { rendering -->
```{r render_book, eval=FALSE, echo=FALSE}
#here::i_am("manuscripts/reportNov2021/rmd/index.Rmd")
#setwd("manuscripts/reportNov2021/rmd")
#Render the whole book in R with:
system.time(bookdown::render_book("index.Rmd"))
#or a single section (e.g. "Data Sources") with:
bookdown::preview_chapter("index.Rmd")
setwd("../docs")
tools::texi2pdf("../docs/luc_track.tex")
```
<!--- } -->
