...
system.time(bookdown::preview_chapter("Results_en.Rmd"))
```
<!--- } -->
...
here::i_am("manuscripts/reportNov2021/rmd/Results_en.Rmd")
source(here("R", "luc_track.R"))

tar_load(c_post_B_en, store = "../../../_targets")
#print(ls.str(c_post_B_en), max.level = 0)

c_post_B_en$p_B$theme  <- ggplot2::theme_minimal()
c_post_B_en$p_G$theme  <- ggplot2::theme_minimal()
c_post_B_en$p_L$theme  <- ggplot2::theme_minimal()
c_post_B_en$p_D$theme  <- ggplot2::theme_minimal()
```

```{r, make_maps_en, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
region <- "en"
...
c_post_B_en$p_B + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + scale_x_continuous(breaks=c(1960,2000))
```
...
c_post_B_en$p_G + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + scale_x_continuous(breaks=c(1960,2000))
```
...
c_post_B_en$p_L + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + scale_x_continuous(breaks=c(1960,2000))
```
...
c_post_B_en$p_D + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + scale_x_continuous(breaks=c(1960,2000))
```
